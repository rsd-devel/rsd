...
set_property -name "verilog_define" -value "RSD_SYNTHESIS RSD_SYNTHESIS_VIVADO RSD_SYNTHESIS_ZEDBOARD RSD_USE_EXTERNAL_MEMORY RSD_DISABLE_DEBUG_REGISTER RSD_ENABLE_FP_PATH" -objects $obj
