...
export RSD_QUESTASIM_PATH=~/opt/cad/mentor/modelsim_10.4c/modeltech/bin


# Specify the binary path of Synplify.
export SYNOPSYS_BIN=~/opt/cad/synopsys/fpga_J-2014.09-SP1/bin/
...
export RSD_VIVADO_BIN=~/opt/cad/xilinx/Vivado/2016.4/bin
