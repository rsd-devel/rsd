...
TEST_MODULES = \
	...
	Verification/TestMainMemBridge.sv	# Verification/TestMain.sv 
...
RUN_TEST = python ../Tools/TestDriver/RunTest.py
RUN_TEST_OMIT_MSG = python ../Tools/TestDriver/RunTest.py -o
